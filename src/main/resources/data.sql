...
insert into Fuel (id, expedition_id, liters, place_of_refueling, cost, currency_code, kilometers, payment_method, refueling_to_full, date_of_fueling) values (nextval('fuel_seq'), 2, 70, 'Gorzow Wlkp.', 20, 'PLN', 250, 'cash', true, '2019-09-10');
insert into Fuel (id, expedition_id, liters, place_of_refueling, cost, currency_code, kilometers, payment_method, refueling_to_full, date_of_fueling) values (nextval('fuel_seq'), 4, 70, 'Berlin', 30, 'EUR', 250, 'cash', true, '2019-09-11');
insert into Fuel (id, expedition_id, liters, place_of_refueling, cost, currency_code, kilometers, payment_method, refueling_to_full, date_of_fueling) values (nextval('fuel_seq'), 4, 30, 'Shell', 40, 'EUR', 20, 'cash', true, '2019-09-13');

insert into FREIGHT_RATE (id, amount, currency_code, freight_company, freight_distance,expedition_id, date,end_date, city_departure,city_arrival) values (nextval('freight_seq'),100,'EUR','Big Company',789,1,'2019-08-07','2019-08-09','Leszno','Poznań');
insert into FREIGHT_RATE (id, amount, currency_code, freight_company, freight_distance,expedition_id, date,end_date, city_departure,city_arrival) values (nextval('freight_seq'),700,'PLN','Bigger Company',1458,1,'2021-05-09','2021-05-12','Wroclaw','Warszawa');
insert into FREIGHT_RATE (id, amount, currency_code, freight_company, freight_distance,expedition_id, date,end_date, city_departure,city_arrival) values (nextval('freight_seq'),300,'PLN','Brand',457,1,'2019-11-10','2019-09-15','Kraków','Berlin');
insert into FREIGHT_RATE (id, amount, currency_code, freight_company, freight_distance,expedition_id, date,end_date, city_departure,city_arrival) values (nextval('freight_seq'),300,'PLN','Brand',457,4,'2019-11-30','2019-12-15','Warszawa','Poznań');
insert into FREIGHT_RATE (id, amount, currency_code, freight_company, freight_distance,expedition_id, date,end_date, city_departure,city_arrival) values (nextval('freight_seq'),300,'PLN','Brand',457,5,'2019-09-10','2019-12-24','Mediolan','Madryt');
...
insert into JOURNEY(id,expedition_id,start_date,end_date,start_place,end_place,meter_reading_departure,meter_reading_arrival,comments) values (nextval('journey_seq'),4,'2099-01-04','2019-12-16','Warszawa','Luboń',5248965,6458965,'small crash with asteroid');
insert into JOURNEY(id,expedition_id,start_date,end_date,start_place,end_place,meter_reading_departure,meter_reading_arrival,comments) values (nextval('journey_seq'),5,'2099-01-04','2019-12-23','Mediolan','Madryt',5248965,6458965,'small crash with asteroid');
